...
public final class OrderNaoConstants {
	...
	public static final String ERROR_PRODUCT_PRICE_LESS_THAN_ZERO = "Product price can't be less than zero.";
	public static final String ERROR_MSG = "Error occured during operation,try again";
	public static final String VALUES_LESS_THAN_ZERO = "Values of Total Service Amount to deposit & Money provided in morning can't be less than zero.";
	public static final String SUSPICIOUS_ACTIVITY_MSG_HEADER = "Warning";
	public static final String SUSPICIOUS_ACTIVITY_MSG = "Suspicious Activity Detected";
	...
	public static final String PATH_SAVE_PRODUCT_PRICE_OF_ORDER = "/save-product-price-of-order";
	public static final String REQUEST_PARAM_PRODUCT_PRICE = "productPrice";
